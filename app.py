...
def get_passwords():
    conn = sqlite3.connect("passwords.db")
    c = conn.cursor()
    c.execute("SELECT id, website, username FROM passwords")  # Do NOT fetch passwords directly
...
def generate_password():
    new_password = secrets.token_urlsafe(12)  # Generate a random 12-character password
